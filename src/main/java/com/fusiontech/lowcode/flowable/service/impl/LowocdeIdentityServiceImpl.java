...
//@Service
@Slf4j
public class LowocdeIdentityServiceImpl extends IdmIdentityServiceImpl {

    ApplicationContext applicationContext;

    public LowocdeIdentityServiceImpl(ApplicationContext applicationContext, IdmEngineConfiguration idmEngineConfiguration) {
