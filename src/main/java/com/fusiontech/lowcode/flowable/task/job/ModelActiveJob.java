package com.fusiontech.lowcode.flowable.task.job;

import com.fusiontech.lowcode.flowable.model.consts.ModelTypeConst;
...
/**
 * 模型激活 flowable-ui里创建的模型不能直接使用，需要激活 定时发布
 * @Author: mayike
