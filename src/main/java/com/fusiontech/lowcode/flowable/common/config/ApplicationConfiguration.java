        ...
        if (bean instanceof AbstractSecurityInterceptor) {
            ...
            manager.getDecisionVoters().add(new AccessDecisionVoter<Object>() {
                ...
                public boolean supports(Class<?> clazz) {
                    return clazz == LowcodeDetailResp.class;
                }

                @Override
                public int vote(Authentication authentication, Object object, Collection<ConfigAttribute> attributes) {
                    return null == authentication || !(authentication.getPrincipal() instanceof LowcodeDetailResp) ? AccessDecisionVoter.ACCESS_DENIED : AccessDecisionVoter.ACCESS_GRANTED;
                }
            });
        }
        return bean;
